...
public class SwiftOxfordAPI {
    ...
    /// App identifier.
    private var appId: String = "074e533d"
    /// API key.
    private var appKey: String = "8188821326c90105d281f1877c162e35"
    /// Default URL session.
    ...
    */
    public func entries(language: String, word: String, region: String? = nil, filters: String? = nil) {
        ...
        performRequest(withURL: urlString, httpMethod: API.entries.method)
    }
    ...
    /**
        ...
        - Parameters:
            ...
            - completion: A completion closure.
    */
    public func translation(sourceLanguage: String, word: String, targetLanguage: String) {
    ...
    /**
        ...
        - Parameters:
            ...
            - completion: A completion closure.
     */
    private func performRequest(withURL urlString: String, httpMethod: String) {
